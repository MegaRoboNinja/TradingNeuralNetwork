...
price_AAPL= yf.download('AAPL', start='2017-11-06', end='2025-05-03', auto_adjust = True)
...
print(trade_price_AAPL['Cumulative Strategy Returns'])
final_cum_return = trade_price_AAPL['Cumulative Strategy Returns'].iloc[-2]
